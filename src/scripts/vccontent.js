...
@param z            z-index
*/
class CanvasSkydriveImageItem {
  constructor(vc, layerid, id, embededSrc, vx, vy, vw, vh, z) {
    this.base = CanvasDomItem;
    this.base(vc, layerid, id, vx, vy, vw, vh, z);
...
*/
class SeadragonImage {
  constructor(vc, parent, layerid, id, imageSource, vx, vy, vw, vh, z, onload) {
    var self = this;
    this.base = CanvasDomItem;
    this.base(vc, layerid, id, vx, vy, vw, vh, z);
    this.onload = onload;
