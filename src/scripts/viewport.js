  ...
  constructor(aspectRatio, width, height, visible) {
    ...
    this.pointVirtualToScreen = function (px, py) {
      return {
        ...
        y: (py - this.visible.centerY) /
          (this.aspectRatio * this.visible.scale) +
          this.height / 2.0,
      };
    };
    ...
    this.pointScreenToVirtual = function (px, py) {
      return {
        ...
        y: this.visible.centerY -
          (this.height / 2.0 - py) * (this.aspectRatio * this.visible.scale),
      };
    };
