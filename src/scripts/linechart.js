...
export default class LineChart {
  constructor(container) {
    ...
    $("#closeTimeChartBtn").click(function () {
      HomePageViewModel.hideTimeSeriesChart();
    });
  }
  static calculateTicks(ymin, ymax, labelCount) {
  ...
  static clear(screenLeft, screenRight) {
  ...
  static drawDataSet(dataSet, screenLeft, screenRight, verticalPadding, plotLeft, plotRight, plotTop, plotBottom) {
    var that = this;
  ...
  // Clipping algorithms
  static code(x, y, xmin, xmax, ymin, ymax) {
    var a = x < xmin ? 1 : 0;
    var b = x > xmax ? 1 : 0;
    var c = y < ymin ? 1 : 0;
    var d = y > ymax ? 1 : 0;
  ...
  static generateAxisParameters(tickOrigin, secondScreenBorder, ymin, ymax, appearence) {
    var that = this;
    var ticksForDraw = [];
  ...
  static drawAxis(ticksForDraw, appearence) {
    var that = this;
    var ctx = this.context;
    ctx.font = appearence.font;
    ctx.textBaseline = 'middle';
  ...
  static drawHorizontalGridLines(ticksForDraw, appearence) {
    var that = this;
    var ctx = this.context;
  ...
  static drawVerticalGridLines(screenLeft, screenRight, plotLeft, plotRight) {
    var ctx = this.context;
    var verticalTicks = Common.axis.ticksInfo;
  ...
  static checkLegendVisibility(screenWidth) {
